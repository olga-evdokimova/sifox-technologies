      ...
      <div className={`hexagon__inner ${styleName}`}>
        ...
        <div className="hexagon__row">
          ...
          >
            ...
            <div className="hexagon__img">
              <Image src="/b2c/b2c-1.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <div className="hexagon__item" style={{ opacity: 0 }}></div>
        </div>
        ...
        <div className="hexagon__row even">
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2b/b2b-1.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <Link
            className="hexagon__item"
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2b/b2b-4.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <div className="hexagon__item">
            <div className="hexagon__hover"></div>
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2c/b2c-2.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <div className="hexagon__item" style={{ opacity: 0 }}></div>
        </div>
        ...
        <div className="hexagon__row">
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2b/b2b-2.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2c/b2c-6.png" alt="image" fill sizes="500" />
            </div>
          </Link>
        ...
        <div className="hexagon__row even">
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2c/b2c-4.png" alt="image" fill sizes="500" />
            </div>
          </Link>
        </div>
        ...
        <div className="hexagon__row">
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2b/b2b-3.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <div className="hexagon__item" style={{ opacity: 0 }}></div>
          <Link
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2c/b2c-5.png" alt="image" fill sizes="500" />
            </div>
          </Link>
          <Link
            className="hexagon__item"
          ...
          >
            ...
            <div className="hexagon__hover"></div>
            <div className="hexagon__img">
              <Image src="/b2c/b2c-3.png" alt="image" fill sizes="500" />
            </div>
          </Link>
        </div>
      </div>
