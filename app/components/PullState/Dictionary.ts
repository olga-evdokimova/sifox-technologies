export const Dictionary: Record<string, Record<string, string>> = {
    "en": {
        //TopBlock
        "text_h1_span": "TRANSFORMING TELECOMS, CONNECTING PEOPLE",
        "text_h1": "INNOVATING WITH TELECOM PROVIDERS TO DELIVER SEAMLESS, ACCESSIBLE, AND REVENUE-DRIVEN MOBILE SERVICES",
        "products": "Products",
        "about": "About",
        //Products
        ...
        "Our_mission_at_SIFOX_Technologies": "Our mission at SIFOX Technologies is to partner with Mobile Network Operators (MNOs) and boost their data and voice package sales to both consumers and enterprise customers.",
    ...
    "fr": {
        //TopBlock
        "text_h1_span": "TRANSFORMER LES TÉLÉCOMS, CONNECTER LES PERSONNES",
        "text_h1": "INNOVER AVEC LES OPÉRATEURS TÉLÉCOMS POUR OFFRIR DES SERVICES MOBILES FLUIDES, ACCESSIBLES ET GÉNÉRATEURS DE REVENUS",
        "products": "Produits",
        "about": "Ã propos",
        //Products
        ...
        "Resource_Management_Platform": "Plateforme de Gestion des Ressources (RMP)",
        ...
        "Our_mission_at_SIFOX_Technologies": "Notre mission chez SIFOX Technologies est de collaborer avec les opérateurs de réseaux mobiles (MNO) pour augmenter leurs ventes de forfaits data et voix auprès des consommateurs et des entreprises.",
